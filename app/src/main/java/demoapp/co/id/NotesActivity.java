...
import demoapp.co.id.adapter.AdapterDaftarCatatan;
...
public class NotesActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        simpanCatatan.setOnClickListener(v -> {
            ...
            if (edit) {masukkanCatatan = dbHelper.perbaharuiCatatan(sgd, id);
            } else {
        ...
        daftarCatatan.setOnClickListener(v -> dialogDaftarCatatan());
    ...
    private void dialogDaftarCatatan () {
        ...
        hapusSemuaCatatan.setOnClickListener(v1 -> {
